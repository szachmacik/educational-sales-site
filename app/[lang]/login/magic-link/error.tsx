...
export default function LoginMagic_linkError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[LoginMagic_link Error]", error)
  }, [error])
    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center space-y-4 max-w-md mx-auto px-4">
        ...
        <p className="text-muted-foreground text-sm">
          Nie udało się załadować weryfikację. Spróbuj ponownie lub wróć do strony głównej.
        </p>
