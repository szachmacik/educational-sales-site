...
export default function AdminWorkshopError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[AdminWorkshop Error]", error)
  }, [error])
    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center space-y-4 max-w-md mx-auto px-4">
        ...
        <p className="text-muted-foreground text-sm">
          Nie udało się załadować warsztat. Spróbuj ponownie lub wróć do strony głównej.
        </p>
