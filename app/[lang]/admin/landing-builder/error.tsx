...
export default function AdminLanding_builderError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[AdminLanding_builder Error]", error)
  }, [error])
    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center space-y-4 max-w-md mx-auto px-4">
        ...
        <p className="text-muted-foreground text-sm">
          Nie udało się załadować builder stron. Spróbuj ponownie lub wróć do strony głównej.
        </p>
