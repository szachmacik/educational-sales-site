...
export default function Polityka_prywatnosciError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[Polityka_prywatnosci Error]", error)
  }, [error])
    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center space-y-4 max-w-md mx-auto px-4">
        ...
        <p className="text-muted-foreground text-sm">
          Nie udało się załadować politykę prywatności. Spróbuj ponownie lub wróć do strony głównej.
        </p>
